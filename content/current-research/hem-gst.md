...
{{< callout >}}
**In plain terms:** Blood stem cells are the master cells that continuously replenish our entire blood and immune system. If we could make them from a patient's own skin or blood cells in the lab, we could cure leukemia, sickle cell disease, and many other blood disorders without needing a matched donor. Despite decades of trying, this hasn't worked yet — because existing lab methods grow cells in a simplified soup of chemicals that looks nothing like the environment where blood stem cells are actually born in a developing embryo. We are taking a different approach: instead of adding the right signals one by one from the outside, we let the stem cells organize themselves into a tiny, embryo-like structure that spontaneously builds the right environment from within. These structures — which we call hemogenic gastruloids — naturally produce several of the cell types that surround and instruct blood stem cells in the embryo, and the blood stem-like cells they generate look remarkably similar to those found in a real human embryo. We are now working to understand exactly which cells within this structure give rise to the best blood stem cells, and how to make the environment even more complete — with the ultimate goal of producing transplantable human blood stem cells entirely in the lab.
{{< /callout >}}
